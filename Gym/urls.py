...
from gym_app.views import (
    ...
    AddTrainingView,
    ReservationView,
    ShowTrainingDetailsView,
    UserReservationsView,
    ShowStaffView,
    ShowRoomDetailsView,
    UserReservationDeleteView,
)
...
urlpatterns = [
    ...
    path(
        "staff_details/<int:id>/", ShowStaffDetailsView.as_view(), name="staff-details"
    ),
    ...
    path(
        "training_details/<int:id>/",
        ShowTrainingDetailsView.as_view(),
        name="training-details",
    ),
    path(
        "reservation_delete/<int:id>/",
        UserReservationDeleteView.as_view(),
